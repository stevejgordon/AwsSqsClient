...
namespace System.Text.Http.Parser
{
    public interface IHttpParser
    {
        ...
        bool ParseHeaders<T>(ref T handler, in ReadOnlySequence<byte> buffer, out SequencePosition consumed, out SequencePosition examined, out int consumedBytes) where T : IHttpHeadersHandler;
